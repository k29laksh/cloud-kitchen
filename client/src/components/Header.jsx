  ...
  return (
    <>
      <div className="font-Poppins sticky top-0 left-0 right-0 mx-24 rounded-b-3xl bg-zinc-900/95 z-50">
        {/* Header Section */}
        <header className="text-gray-100 py-6 px-12 flex justify-between items-center rounded-b-3xl">
          ...
          <div className="flex items-center  space-x-6">
            <IoMdNotificationsOutline className="text-gray-100" size={32} />
            <PiShoppingCartSimple className="text-gray-100" size={32} />
            {user ? (
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-gray-100 text-lg ">Lucky</span>
              </div>
            ) : (
