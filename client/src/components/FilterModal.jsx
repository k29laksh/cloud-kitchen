    ...
    <>
      {isOpen && (
        <div className="fixed font-Poppins inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div
            ref={modalRef}
            className="relative bg-white rounded-lg shadow-lg w-[850px]"
          >
            {/* Close button */}
            <button
              onClick={closeModal}
            ...
            <div className="p-4 border-b">
              <h2 className="text-3xl font-medium py-3 px-2">Filters</h2>
            </div>
            ...
            <div className="flex">
              ...
              <div className="w-1/2 border-r p-4">
                <div className="text-xl pb-2">Filter By Food or Kitchens</div>
                <input
                  className="px-2 w-full outline-none text-lg py-3 border border-gray-400 rounded-lg"
                  type="search"
                  placeholder="Search"
                />
              </div>
              ...
              <div className="w-2/3 p-4">
                <div className="mt-2 flex gap-8">
                  <label className="flex items-center text-xl mb-2">
                    <input
                      type="radio"
                      name="sort"
            ...
            <div className="flex justify-between p-4 border-t">
              ...
              <button
                className="px-8 py-3 bg-orange-500 text-lg text-white rounded-lg hover:bg-orange-600"
                onClick={closeModal}
              >
                Apply
              </button>
