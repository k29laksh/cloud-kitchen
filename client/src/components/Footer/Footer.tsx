...
const Footer = () => {
  return (
    <footer className="text-sm flex flex-col justify-between md:flex-row gap-1 sm:fap-0 bg-zinc-900 text-white p-4 lg:py-5 sm:mx-12 md:mx-20 lg:mx-24 sm:rounded-t-3xl">
